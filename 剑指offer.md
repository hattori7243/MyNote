...
![](https://raw.githubusercontent.com/hattori7243/img/master/20210624141136.png)
...
![](https://raw.githubusercontent.com/hattori7243/img/master/20210624162113.png)

![](https://raw.githubusercontent.com/hattori7243/img/master/20210624162122.png)

按照正常指针新建一个对应的链表简单，但是需要复制复杂指针就需要知道原来的A现在是多少，原来的B现在是多少。

即我们要能够做到通过旧节点找到新节点来完成复杂指针的复制

### 哈希表记录对应关系

**时间复杂度O(n)，空间复杂度O(n)**

将旧节点和新节点的对应关系保存在哈希表中。
...
将旧节点和新节点的对应关系利用位置来保存。

即将新节点固定放在旧节点后面，然后复制完指针再拆成两个链表。

![](https://raw.githubusercontent.com/hattori7243/img/master/20210624162614.png)
